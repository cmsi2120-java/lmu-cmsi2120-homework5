...
public class WikiWalkerGradingTests {
    ...
    @Test
    public void testClickthroughs_t2() {
        setupWWCycle(ww);
        assertEquals(0, ww.clickthroughs("A", "B"));
        assertEquals(0, ww.clickthroughs("D", "A"));
        assertEquals(-1, ww.clickthroughs("C", "B"));
        assertEquals(-1, ww.clickthroughs("C", "C"));
    }
    @Test
    public void testClickthroughs_t3() {
        setupWWIslands(ww);
        assertEquals(0, ww.clickthroughs("A", "B"));
        assertEquals(0, ww.clickthroughs("B", "C"));
        assertEquals(0, ww.clickthroughs("G", "K"));
        assertEquals(-1, ww.clickthroughs("F", "A"));
        assertEquals(-1, ww.clickthroughs("F", "Z"));
    }
